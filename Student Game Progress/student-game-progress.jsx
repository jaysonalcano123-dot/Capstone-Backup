                        ...
                        <div className="stats-card-grid standalone-stats-grid">
                            ...
                            <div className="inner-stat-card">
                                ...
                                <div className="stat-card-body">
                                    <span><span className="text-huge">3/3</span> <span className="text-sub">Chapter</span></span>
                                    <span><span className="text-huge">100%</span> <span className="text-sub">Percent</span></span>
                                </div>
                            </div>
                            ...
                            <div className="inner-stat-card">
                                ...
                                <div className="stat-card-body">
                                    <span><span className="text-huge">10</span> <span className="text-sub">minutes</span></span>
                                    <span><span className="text-huge">15</span> <span className="text-sub">seconds</span></span>
                                </div>
                            </div>
                        </div>
                        </div>
