            ...
            <div className="layout-container">
                ...
                <div className="main-content">
                    ...
                    <main className="page-body">
                        ...
                        <div className="data-card">
                            <div className="card-header-row">
                                ...
                                <div className="header-actions">
                                    <button className="btn btn-pill-outline" onClick={() => openInsertModal()}>Insert Record</button>
                        ...
                        {/* STUDENT LOGIN CREDENTIALS TABLE */}
                        <div className="data-card">
                            <div className="card-header-row">
                        ...
                        <div className="modal-box">
                            <div className="modal-header">
                                <div>
                                    ...
                                    <p className="modal-subtitle">Enter student credentials and personal details below.</p>
                                </div>
                        ...
                        <div className="modal-box" style={{ maxWidth: '500px' }}>
                            <div className="modal-header">
                                <div>
                                    ...
                                    <p className="modal-subtitle">Set up login credentials for a student.</p>
                                </div>
